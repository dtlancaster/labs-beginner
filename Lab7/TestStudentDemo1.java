...
{
    private String className = "StudentDemo";    
     ...
     */
    public void checkStudentDemo()
    {
        className = "StudentDemo";
        printHeader("StudentDemo");

        fail = false;

        checkNumberOfFields(0);
        checkClass();        
        //checkFields();
        //checkConstructor();
    ...
    {
        Field[] fields = StudentDemo.class.getDeclaredFields();
