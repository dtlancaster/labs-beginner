...
public class TestPrelab
{
    ...
    public void checkEmployee()
    {
        ...
        //3, 4, ... parameter list of types. None if no parameters.
        checkMethod("toString", "String");
        checkMethod("computeWeeklyPay", "double");
        //checkStaticMethod("numberMissing", "int", "int[]");
        //checkNoCopyConstructor(Pilot.class);
        
        checkAMOStringLimit("name", "AB", "CD", "EF", "GH", "IJ");       
        checkAMOStringLimit("idNumber", "AB", "CD", "EF", "GH", "IJ");       
        checkAMOStringLimit("hireDate", "AB", "CD", "EF", "GH", "IJ");       
        checkAMOEnum("shift", "ShiftType");
     ...
     */
    @Test
    public void checkProductionWorker()
    {
        fail = false;
        ...
        checkFields();
        checkConstructor();
        checkConstructor("String", "String", "String",
            "ShiftType", "double", "double");
        checkMutators();
        checkAccessors();
        //checkMain();
        //CheckMethod parameters 
        ...
        checkMethod("toString", "String");
        checkMethod("computeWeeklyPay", "double");
        checkParent("Employee");
        //checkStaticMethod("numberMissing", "int", "int[]");
        //checkNoCopyConstructor(Pilot.class);
        
        checkAMODoubleLimit("hourlyPayRate", 7.25, 25);
        checkAMODoubleLimit("hoursWorked", 0, 70);
     ...
     */
    @Test
    public void checkShiftSupervisor()
    {
        fail = false;
        
        //Check this class
        className = "ShiftSupervisor";
    ...
    public void checkTeamLeader()
    {
        ...
        checkConstructor();
        checkConstructor("String", "String", "String",
            "ShiftType", "double", "double", "int", "double");
        checkMutators();
        checkAccessors();
        //checkMain();
        //CheckMethod parameters 
        ...
        checkMethod("toString", "String");
        checkMethod("computeWeeklyPay", "double");
        checkParent("ProductionWorker");
        //checkStaticMethod("numberMissing", "int", "int[]");
        //checkNoCopyConstructor(Pilot.class);
        
        checkAMOIntLimit("trainingHours", 0, 40);
        checkAMODoubleLimit("weeklyBonus", 0, 1000);
     ...
     */
    public void checkParent(String parent)
    {
        try
        {
            testClass = Class.forName(className);
